    ...
    <section className=' mx-auto max-w-7xl'>
      <div>
          ...
          <p className='mt-2 text-[#666e75] text-[16px] max-w[500px]'>
           Create your own imaginative and stunning images from DaLL-E AI and share them with the community!!
          </p>
        </div>
        <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
          ...
          <div className='mt-10 '>
            <p className='mt-2 text-[#666e75] text-[14px]'>Created the image? Share it with the community 😉</p>
